...
def train():
    ...
    with open(os.path.join(os.path.dirname(__file__),"pointcloud_classifier_data","pointcloud_class_info.json"), 'w') as file:
    ...
    model.save_weights(os.path.join(os.path.dirname(__file__),"pointcloud_classifier_data","pointcloud_classification_model"))
...
def classify(object_path):
    ...
    model.load_weights(os.path.join(os.path.dirname(__file__),"pointcloud_classifier_data","pointcloud_classification_model"))

    with open(os.path.join(os.path.dirname(__file__),"pointcloud_classifier_data","pointcloud_class_info.json")) as json_file:
